...
**Hello Rails-React** Set up a "Hello world" project as one app with Webpack
...
Use the following URL to clone this project:
    ...
    https://github.com/yemidada/hello-rails-react.git
...
Feel free to check the [issues page](https://github.com/yemidada/hello-rails-react/issues).
